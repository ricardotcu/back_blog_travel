...
let Post = (_dec = (0, _typeorm.Entity)('post'), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)("uuid"), _dec3 = (0, _typeorm.Column)("varchar"), _dec4 = (0, _typeorm.Column)("varchar"), _dec5 = (0, _typeorm.Column)("varchar"), _dec6 = (0, _typeorm.ManyToOne)(type => _User.User, user => user.posts), _dec7 = (0, _typeorm.OneToMany)(type => _Comentario.Comentario, comentario => comentario.post), _dec(_class = (_class2 = (_temp = class Post {
  constructor() {
    _initializerDefineProperty(this, "id", _descriptor, this);

    _initializerDefineProperty(this, "titulo", _descriptor2, this);
    ...
    _initializerDefineProperty(this, "comentarios", _descriptor6, this);
  }
  ...
  writable: true,
  initializer: null
}), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "titulo", [_dec3], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
  ...
  writable: true,
  initializer: null
}), _descriptor6 = _applyDecoratedDescriptor(_class2.prototype, "comentarios", [_dec7], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
