...
class createralations1594932401330 {
  async up(queryRunner) {
    ...
    await queryRunner.query(`ALTER TABLE "comentario" ADD CONSTRAINT "FK_5652456e912c983cde73d3281db" FOREIGN KEY ("comentarioId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
  }
